...
description: SolidStart is great! Except that the SSG support feels a bit bare-bones and there's some QoL improvements missing when working with MDX as well.
date: 2024-09-04
...
## 1. List all posts programmatically
...
## 2. Keeping a post's metadata in the same file as the content
...
## 3. Compile-time code highlighting
